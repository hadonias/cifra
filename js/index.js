...
radioCodificar.addEventListener("change", function(){
    submitButton.value = "Criptografar !"
});

radioDecodificar.addEventListener("change", function(){
    submitButton.value = "Decodificar !"
});
...
submitButton.addEventListener('click', function(e){
    ...
    if(seletor.value === "Base64"){
        if(submitButton.value === "Criptografar !"){
            hImprimeMsg.innerText = "Sua mensagem foi criptografada:"
            pImprimeMsg.innerText = codificarBase();
            
        }else{
            hImprimeMsg.innerText = "Sua mensagem foi decodificada:"
